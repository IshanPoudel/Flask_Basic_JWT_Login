...
if __name__ == '__main__':
    ...
    email = "workflow_tester@gmail.com"
    password = "workflow"
    ...
    # Test adding a model
    tags = [1, 2]
    master_model_file_path = "/home/ec2-user/dummy_stock_models_for_upload/"

    #All_models
    models_names = ['AdaBoost.joblib','GradientBoosting.joblib' , 'LGBMRegressor.joblib' , 'RandomForest.joblib' ,
    'DecisionTree.joblib' ,   'KNeighbors.joblib' ,        'LinearRegression.joblib' ,  'SVR.joblib'
    ]

    for model_name in models_names:
        model_file_path = master_model_file_path+model_name
        description = "This is a test for " + model_name
